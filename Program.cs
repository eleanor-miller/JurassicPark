            ...
            while (keepGoing)
            {
                ...
                switch (input)
                {
                    ...
                    case "R":
                        ...
                        Dinosaur dinosaurBeingRemoved = DinosaurDatabase.Remove(Console.ReadLine());
                    ...
                    case "T":
                        Console.Write("What is the name of the dinosaur would you like to transfer? ");
                        ...
                        {
                            Console.WriteLine($"{dinosaurBeingTransferred.Name} has been transferred to the new enclosure! ");
                        }
                        else
                        {
                            Console.WriteLine("There is no record of this dinosaur, maybe it's extinct? ☄️ ");
                    ...
                    case "V":
                        Console.Write("View by (N)ame or (E)nclosure? ");
